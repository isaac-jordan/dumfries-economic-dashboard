...
urlpatterns = patterns('',
    ...
    url(r'^deleteSavedConfig', 'dashboard.views.ajaxDeleteSavedConfig', name='deleteSavedConfig'),
    url(r'^loadSavedConfig', 'dashboard.views.ajaxloadSavedConfig', name='loadSavedConfig'),
    url(r'^getGraphs', 'dashboard.views.ajaxGetGraphs', name='getGraphs'),
